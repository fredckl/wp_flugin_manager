<?php
/**
 * Plugin Name: Flugin Manager
 * Author: Frédéric KOLLER
 * Description: Helper for construct your plugin
 * Version: 1.0
 * Date: 2018-12-11
 * Time: 15:27
 */
...
require_once __DIR__ . DS . 'paths.php';
...
$box = new FluginMetabox('fk_metabox', 'Information', 'etalon');
$box->addTextField(
    'price',
    'Prix',
    null,
